        ...
        <>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <label htmlFor="location">
                    <h3>
                        Location: {" "}
                        <input value={formData.location} onChange={handleChange} id="location" type="text" name="location" alt="company" placeholder="Company's Branch" />
                    </h3>
                </label>
                {/* <br /> */}
                ...
                <label htmlFor="mod_id">
                    <h3>
                        ...
                        <select
                            ...
                            required
                        >
                            {/* shows each 'moderator' in a dropdown menu when selected */}
